...
(function() {
    ...
    setTimeout(() => {
        ...
        function clickElement(e) {
            var t = _0x5a8b5d,
                o = new MouseEvent(t(297), { view: window, bubbles: true, cancelable: true });
            e[t(298)](o);
        }
        ...
        function checkClaimButton() {
            ...
            return (
                !!t &&
                (clickElement(t), console[e(315)](e(301)), setTimeout(closePopup, 2e3), true)
            );
        }
        ...
        function checkConditionsAndRetry() {
            ...
            t[e(304)] > 0 || o[e(304)] !== elementsToClick.length
